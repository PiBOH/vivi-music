...
data class MusicTwoRowItemRenderer(
    ...
    // "Library artist" as well: the artist cards of the saved-artists corpus
    // ("FEmusic_library_corpus_artists") are marked with that page type, and
    // reading only MUSIC_PAGE_TYPE_ARTIST dropped every one of them — the
    // Artists screen rendered empty even though the page had loaded fine. The
    // responsive-list parser next to this one already accepts both.
